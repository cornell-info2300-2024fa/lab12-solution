      ...
      <?php } else { ?>
        ...
        <form id="request-form" action="/cooking-classes#request" method="post" novalidate>
          ...
          <?php if ($show_feedback["courses"]) { ?>
            <div id="feedback-classes" class="feedback">Please select one or more classes.</div>
          <?php } ?>
          ...
          <?php if ($show_feedback["email"]) { ?>
            <div id="feedback-email" class="feedback">Please provide a valid email address.</div>
          <?php } ?>
